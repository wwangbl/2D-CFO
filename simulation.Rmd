...
simulate1 <- function(i){
  ...
  pcs.dfcomb <<- pcs.dfcomb + res.dfcomb$correct
  npercent.dfcomb <<- npercent.dfcomb + as.numeric(sub("%","",res.dfcomb$npercent))/100
  ntox.dfcomb <<- ntox.dfcomb + res.dfcomb$ntox
}
...
r <- mclapply(1:10, simulate1(i), mc.cores = n.cores)
```
